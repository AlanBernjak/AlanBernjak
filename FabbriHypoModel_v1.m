% function runs the Fabbri model with default input parameters
% Ko=4mmol/L, gKr=1 (max conductance) and IVshift=0 (no shift)
...
% 'plot_Fabbri' plots the AP waveform from the output structure
...
% input parameters can be sampled randomly by setting the nSamples variable
% and setting the range for each variablt in the 'generateDesignData'
% function 

% Use GenerateDesignData2 for existing set of parameters (symp or vagal
% activities can be added to existing data)
...
save testFabbri X parameters FabbriOutput biomarkers
