% Script reproduces Figure8b
% Corresponding data are in files 'Figure8a_data1' and 
% 'Figure8b_data1' to 'Figure8b_data4'
...
BLsymp=load('Figure8b_data1');
BLsymp_lowg=load('Figure8b_data2');
BLsymp_hypoKo35=load('Figure8b_data3');
BLsymp_hypoKo3=load('Figure8b_data4');
...
ll=legend('NG, {\itK}o=4',...
          'NG, {\itK}o=4 + Parasymp.Act.',...
          'LG, {\itK}o=4 + Parasymp.Act.',...
          'LG, {\itK}o=3.5 + Parasymp.Act.',...
          'LG, {\itK}o=3 + Parasymp.Act.');
...
set(gca,'fontsize',18)
set(ll,'fontsize',16,'position',[0.17 0.57 0.3 0.34])
